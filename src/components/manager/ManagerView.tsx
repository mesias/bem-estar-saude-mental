          ...
          {activeCampaign ? (
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs dark:border-slate-800 dark:bg-slate-900">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-slate-200 pb-4 dark:border-slate-800 gap-3">
                ...
                <div className="flex items-center gap-2">
                  <button
                    id="btn-copy-user-link"
                    onClick={handleCopyUserLink}
                    className="flex items-center gap-1.5 rounded-xl border border-slate-300 bg-white px-3 py-2 text-xs font-semibold text-slate-700 shadow-sm hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 transition-colors"
                    title="Copiar link isolado do participante para enviar por WhatsApp ou E-mail"
                  >
                    {copiedLink ? (
                      <>
                      ...
                      <>
                        ...
                        <span>Copiar Link do Docente (?role=user)</span>
                      </>
                    )}
                  </button>
